...
let newSelect=document.getElementById("countries");
let index=0;
for(element in country_list)
{  
   var opt = document.createElement("option");
   opt.value= country_list[index].name; 
   opt.innerHTML = country_list[index].name; // whatever property it has
...
function setCountryName(){
    ...
    user_country=document.getElementById("countries").value;
